...
enseignants: any[] = [
  ...
  { nomPrenom: 'FOURATI KALLEL Imen', grade: 'Maitre assistant', email: 'imen.fourati@enetcom.usf.tn' ,description:["- Cours assurés :" , "* Reconnaissances des formes et vision par ordinateur" , "* Traitement de signal"	, "* Traitement numérique des signaux" , "* Traitement d'image et vidéo"	,"- TP assurés :" ,"* Préparation à la certification NI"]},
  ...
  { nomPrenom: 'HENTATI Manel', grade: 'Maitre assistant', email: 'Manel.Hentati@enetcom.usf.tn' ,description:["- Cours assurés :" , "* Programmation des systèmes embarqués (STM32)"	, "* Architecture des Systèmes Programmables"	, "* Programmation STM32"	, "* Algo C embarqué"	, "* Architecture programmable avancée" , "Architecture des microcontrôleurs" , "Architecture des circuits programmables (GEC-S4)"	, "Dispenser les TPS :", "Architecture programmable avancée" , "Processeur embarquée  (GEC-S4)"]},
  ...
  { nomPrenom: 'KALLEL Mohamed', grade: 'Maitre assistant', email: 'mohamed.kallel@enetcom.usf.tn' ,description:["- Cours assurés :","* Electronique numérique","* Reconnaissances des formes et vision par ordinateur","* Vision par ordinateur","* Interaction homme machine","* Intelligence artificielle et Deep learning","* Traitement d'image et vidéo","- TP assurés :","* Traitement d'image et vidéo"]},

  { nomPrenom: 'KSANTINI Nesrine', grade: 'Maitre assistant', email: 'Nisrine.Kossentini@enetcom.usf.tn' ,description:["- Cours assurés :","* VHDL","* Electronique générale","* Electronique modulaire","* Electronique analogique 1","* VHDL-AMS","- TP assurés :","* VHDL","* VHDL AMS"]},
  ...
  { nomPrenom: 'MASMOUDI Wafa', grade: 'Maitre assistant', email: 'wafa.masmoudi@enetcom.usf.tn' ,description:["- Cours assurés :", "* Instrumentation et Métrologie" , "* Mécanique" , "* Electromagnétisme" , "* Thermodynamique"	, "- TP assurés :" , "* Instrumentation et Métrologie" , "* Mécanique" , "* Electromagnétisme"]},
  ...
  { nomPrenom: 'MARZOUK AYEDI Rim', grade: 'Maitre assistant', email: 'rim.Marzouk@enetcom.usf.tn' ,description:["- Cours assurés :" ,"* Fonctions d'électronique  analogique"	, "* Electronique numérique"	, "* Réseaux de capteurs sans fil" , "* Instrumentation et chaines de mesure" , "* POO C++", "- TP assurés :", "* Réseau de capteurs sans fil"	, "* UML","* POO C++"]},
  ...
  { nomPrenom: 'SHABOU Sonda', grade: 'Assistant', email: 'Sonda.Shabou@enetcom.usf.tn',linkedin:'...0' ,description:["- Cours assurés :" , "* Circuit électrique" , "* Electronique pour les télécommunications"	, "* Electronique Analogique" , "* Electronique Modulaire" , "- TP assurés :" ,"* Electronique pour les télécommunications","* Electronique Analogique","* Electronique Modulaire"]},
